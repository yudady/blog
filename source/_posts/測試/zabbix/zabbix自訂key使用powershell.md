...
```
![](zabbix自訂key使用powershell/20181011141941.png)

> .\cmd.ps1 org

![PowerShell](zabbix自訂key使用powershell/20181009150946.png)
...
## How to debug
![](zabbix自訂key使用powershell/debug.gif)
...
![](zabbix自訂key使用powershell/20181011141413.png)
